...
class CA:
    ...
    def __init__(self, n_components=None):
        ...
        Adapted from: https://github.com/YiChanLee/correspondence-analysis
    ...
    def fit(self, contingency_table, y=None):
        ...
        contingency_table = nn.tensor(contingency_table).to(device)
        ...
        expc_freq = nn.kron(row_masses.reshape(-1, 1),
